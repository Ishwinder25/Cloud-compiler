...
<html>
    ...
    <script>
        ...
        function java_fetch()
        {
            ...
            xml.open("GET", "./mysharedcode?lang=java", true);
            xml.send();
        }
        function c_fetch()
        {
            ...
            xml.open("GET", "./mysharedcode?lang=c", true);
            xml.send();
        }
        ...
        function cpp_fetch()
        {
            ...
            xml.open("GET", "./mysharedcode?lang=cpp", true);
            xml.send();
        }
        function python_fetch()
        {
            ...
            xml.open("GET", "./mysharedcode?lang=python", true);
            xml.send();
        }
