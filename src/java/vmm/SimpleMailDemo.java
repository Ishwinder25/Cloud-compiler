...
public class SimpleMailDemo {
    ...
    String port = "587";
    String mailFrom = "abc.project5656@gmail.com";
    String password = "5656project.abc";
    ...
    public static void main(String[] args) {
        ...
        SimpleMailDemo obj = new SimpleMailDemo("sidharthbemby@gmail.com", "hello", "testing mail");
    }
}
